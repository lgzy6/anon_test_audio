"""VPC 2024 Pipeline — kNN Top-3 随机采样匿名化（余弦联合距离）"""
import sys
import io
import json
import random
...
class PseudoTargetPipelineTop3:
    ...
    def _load_models(self):
        ...
        print(f"[Top3] 模型加载完成 (mode={self.mode}, alpha={self.alpha}, top_k={self.top_k}, pools={N_POOLS})")
